...
export const INSIGHTS: Insight[] = [
	{
		...
		title:
			"ADR for Global IP Disputes, Part 1: Resources for Disputing Parties",
		excerpt:
			"Part 1 outlines the institutional resources available to parties handling cross-border IP disputes.",
		image: "/insights/semiconductor.jpg",
		variant: "image",
		content: `...`,
		author: "Dr. Daisy Williams",
		date: "Part 1",
		externalUrl: "https://adric.ca/using-alternative-dispute-resolution-adr-to-settle-global-intellectual-property-ip-disputes-part-1-the-resources-available-to-disputing-parties/"
	},
	{
		id: 2,
		slug: "adr-global-ip-disputes-part-2",
		...
		title:
			"ADR for Global IP Disputes, Part 2: Advantages Over Court Litigation",
		excerpt:
			"Part 2 explains why ADR can be better suited than court litigation.",
		image: "insights/globe.jpg",
		variant: "image", // 👈 THIS WILL SHOW GLOBE
		content: `...`,
		author: "Dr. Daisy Williams",
		date: "Part 2",
		externalUrl: "https://adric.ca/using-alternative-dispute-resolution-adr-to-settle-global-intellectual-property-ip-disputes-part-2-the-advantages-of-adr-over-litigation-in-court/"
	},
	{
		id: 3,
		slug: "adr-global-ip-disputes-part-3",
		...
		title:
			"ADR for Global IP Disputes, Part 3: How the CISG Affects Cross-Border Transactions",
		excerpt:
			"Part 3 looks at how the CISG allocates risk in cross-border transactions.",
		image: "/insights/biotech.jpg",
		variant: "image",
		content: `...`,
		author: "Dr. Daisy Williams",
		date: "Part 3",
		externalUrl: "https://adric.ca/using-alternative-dispute-resolution-adr-to-settle-global-intellectual-property-ip-disputes-part-3-the-impact-of-the-convention-on-international-sale-of-goods-cisg-on-cross-b/"
	}
];
